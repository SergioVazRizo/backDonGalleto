...
public class Cookie {
    ...
    public Cookie(int id, String name, int recipeId, String description, String status,
            double unitPrice, double package500gPrice, double package1000gPrice,
            double pricePerGram, int stock, double weightPerUnit) {
        this.id = id;
        this.name = name;
